...
if ($tags) {
	...
	if ( $related_query->have_posts() ) { ?>
		...
		<div class="related-posts-wrap col-md-12">
			
			<h2 class="entry-title"><?php echo of_get_option('blog_related', __('Related Posts','non-cherry')); ?></h2>
	...
	<?php } ?>
	<?php wp_reset_query(); // to reset the loop : http://codex.wordpress.org/Function_Reference/wp_reset_query
} ?>