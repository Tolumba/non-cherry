			...
			$html .= '<div class="cherry-repeater-wrap" data-name="' . $this->settings['name'] . '">';
				$html .= '<div class="cherry-repeater-item-list">';
					$html .= '<div class="cherry-repeater-dublicate-item">';
						$html .= '<div class="col">';
							$html .= '<input class="' . $this->settings['class'] . 'external-link" name="" type="text" placeholder="' . __( 'External link', 'non-cherry' ) . '" value="">';
						$html .= '</div>';
						$html .= '<div class="col">';
							$html .= '<input class="' . $this->settings['class'] . 'font-class" name="" type="text" placeholder="' . __( 'Font class', 'non-cherry' ) . '" value="">';
						$html .= '</div>';
						$html .= '<div class="col">';
							$html .= '<input class="' . $this->settings['class'] . 'link-label" name="" type="text" placeholder="' . __( 'Link label', 'non-cherry' ) . '" value="">';
						$html .= '</div>';
					...
					if( is_array( $this->settings['value'] ) ){
						...
						foreach ( $this->settings['value']  as $handle => $handleArray ) {
							$html .= '<div class="cherry-repeater-item">';
								$html .= '<div class="col">';
									$html .= '<input class="' . $this->settings['class'] . 'external-link" name="' . $this->settings['name'] . '[' . $handle. '][external-link]" type="text" placeholder="' . __( 'External link', 'non-cherry' ) . '" value="' . esc_html( $handleArray['external-link'] ) . '">';
								$html .= '</div>';
								$html .= '<div class="col">';
									$html .= '<input class="' . $this->settings['class'] . 'font-class" name="' . $this->settings['name'] . '[' . $handle. '][font-class]" type="text" placeholder="' . __( 'Font class', 'non-cherry' ) . '" value="' . esc_html( $handleArray['font-class'] ) . '">';
								$html .= '</div>';
								$html .= '<div class="col">';
									$html .= '<input class="' . $this->settings['class'] . 'link-label" name="' . $this->settings['name'] . '[' . $handle. '][link-label]" type="text" placeholder="' . __( 'Link label', 'non-cherry' ) . '" value="' . esc_html( $handleArray['link-label'] ) . '">';
								$html .= '</div>';
