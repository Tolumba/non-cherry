			...
			$html .= '<div id="' . $this->settings['id'] . '" class="cherry-layout-editor-wrap ' . $this->settings['class'] . '">';
				$html .= '<div class="cherry-layout-editor-inner">';
					...
					$html .= '<div class="position-inner">';
						$html .= '<span class="hint-label">' . __( 'position', 'non-cherry' ) .'</span>';
						$html .= '<div class="margin-inner">';
							$html .= '<span class="hint-label">' . __( 'margin', 'non-cherry' ) .'</span>';
							...
							$html .= '<div class="border-inner">';
								$html .= '<span class="hint-label">' . __( 'border', 'non-cherry' ) .'</span>';
								...
								$html .= '<div class="padding-inner">';
									$html .= '<span class="hint-label">' . __( 'padding', 'non-cherry' ) .'</span>';
									...
									$html .= '<div class="container-inner">';
										$html .= '<span class="hint-label">' . __( 'size', 'non-cherry' ) .'</span>';
				...
				$html .= '<div class="border-controls">';
					$html .= '<div class="border-control border-control-style">';
						$border_styles = array(
							'solid'		=> __( 'solid', 'non-cherry' ),
							'dashed'	=> __( 'dashed', 'non-cherry' ),
							'dotted'	=> __( 'dotted', 'non-cherry' ),
							'double'	=> __( 'double', 'non-cherry' ),
							'groove'	=> __( 'groove', 'non-cherry' ),
							'ridge'		=> __( 'ridge', 'non-cherry' ),
							'inset'		=> __( 'inset', 'non-cherry' ),
					...
					$html .= '<div class="border-control border-control-radius">';
						$html .= '<label for="' . $this->settings['id'] . '-border-radius">' . __( 'Border radius', 'non-cherry' ) . '</label> ';
					...
					$html .= '<div class="border-control border-control-color">';
						$html .= '<label for="' . $this->settings['id'] . '-border-color">' . __( 'Border color', 'non-cherry' ) . '</label> ';
