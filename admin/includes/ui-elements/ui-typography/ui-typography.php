	...
	class UI_Typography {
		...
		public function render() {
			...
			$text_align = array(
				...
				'left'			=> __( 'Left', 'non-cherry' ),
				'right'			=> __( 'Right', 'non-cherry' ),
				'center'		=> __( 'Center', 'non-cherry' ),
				'justify'		=> __( 'Justify', 'non-cherry' )
			);
				...
				$html .= '<div class="cherry-column-section">';
					$html .= '<div class="inner">';
						$html .= '<div class="field-font-family">';
							$html .= '<label for="' . $this->settings['id'] . '-family">' . __( 'Font Family', 'non-cherry' ) . '</label> ';
							$html .= '<select id="' . $this->settings['id'] . '-family" class="cherry-ui-select cherry-font-family cherry-filter-select" name="' . $this->settings['name'] . '[family]" style="width: 100%">';
								if( $standart_fonts_array && !empty( $standart_fonts_array ) && is_array( $standart_fonts_array ) ){
									$html .= '<optgroup label="' . __( 'Standard Webfonts', 'non-cherry' ) . '" data-font-type="standart">';
								...
								if( $google_fonts_array && !empty( $google_fonts_array ) && is_array( $google_fonts_array ) ){
									$html .= '<optgroup label="' . __( 'Google Webfonts', 'non-cherry' ) . '" data-font-type="web">';
				...
				$html .= '<div class="cherry-column-section">';
					$html .= '<div class="inner">';
						$html .= '<div class="field-font-size">';
							$html .= '<label for="' . $this->settings['id'] . '-size">' . __( 'Size', 'non-cherry' ) . '</label> ';
						...
						$html .= '<div class="field-font-lineheight">';
							$html .= '<label for="' . $this->settings['id'] . '-lineheight">' . __( 'Line-height', 'non-cherry' ) . '</label> ';
						...
						$html .= '<div class="field-font-letter-spacing">';
							$html .= '<label for="' . $this->settings['id'] . '-letterspacing">' . __( 'Letter-spacing', 'non-cherry' ) . '</label> ';
						...
						$html .= '<div class="field-font-color">';
							$html .= '<label for="' . $this->settings['id'] . '-color">' . __( 'Font color', 'non-cherry' ) . '</label> ';
						...
						$html .= '<div class="field-font-align">';
							$html .= '<label for="' . $this->settings['id'] . '-align">' . __( 'Text align', 'non-cherry' ) . '</label> ';
		...
		public function get_font_variants( $id, $name, $value, $font ){
			...
			if( $variants_array && !empty( $variants_array ) && is_array( $variants_array )){
				$html = '<label for="' . $id . '">' . __( 'Font Style', 'non-cherry' ) . '</label> ';
		...
		public function get_font_subsets( $id, $name, $value, $font ){
			...
			if( $character_array && !empty( $character_array ) && is_array( $character_array )){
				$html = '<label for="' . $id . '-character">' . __( 'Character Sets', 'non-cherry' ) . '</label> ';
